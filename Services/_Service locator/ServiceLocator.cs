...
namespace NTools
{
    public static class ServiceLocator
    {
        ...
        {
            // { typeof(IAudioVolumeService), () => new NullAudioVolumeService() }, // Audio volume service
            // { typeof(ITickService), () => new NullTickService() }, // Tick service
            // { typeof(IFadeScreenService), () => new NullFadeScreenService() } // Fade screen service
        };
